    ...
    <div className="min-h-screen bg-blue-600 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white rounded-2xl p-8 shadow-xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Enter your details to set up your workspace profile</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">GitHub handle (optional)</label>
            <input
              type="text"
              value={githubHandle}
