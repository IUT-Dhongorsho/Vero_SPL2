...
export const handleConnection = async (io: Server, socket: AuthSocket) => {
  ...
  socket.on(SocketEvents.JOIN_ROOM, (channelId: string) => {
  ...
  socket.on(SocketEvents.LEAVE_ROOM, (channelId: string) => {
